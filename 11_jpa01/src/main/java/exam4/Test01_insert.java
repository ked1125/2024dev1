...
//	            user = new Member4("test@test.com","이순신",LocalDate.now());
//	            Member4 user = new Member4("test@test.com","이순신",LocalDate.now());
//	            em.persist(user);
//	            user = new Member4("test@test.com","김유신",LocalDate.now());
//	            Member4 user = new Member4("test@test.com","김유신",LocalDate.now());
	            // 이렇게하면 user가 두개라 에러뜨는데 위에서 Member4 user;로 선언 후 user=로 하면 오류안뜸
//	            em.persist(user);
